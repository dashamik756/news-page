...
//apis
const API_KEY = "b4b4b4e78ee548579b6f465f510a385c";
const HEADLINES_NEWS ="https://newsapi.org/v2/top-headlines?country=in&apiKey=";
const GENERAL_NEWS ="https://newsapi.org/v2/top-headlines?country=in&category=genral&apiKey=";
...
function displayNews(){
    ...
    newsDataArr.forEach(news => {
        ...
        image.setAttribute("height","matchparn");
        ...
        newsHeading.className = "card-tittle";
